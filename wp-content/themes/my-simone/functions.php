...
function my_simone_scripts() {
	...
	//style sheet for lato and pt serif fonts from google fonts
	wp_enqueue_style('my-simone-google-fonts', 'http://fonts.googleapis.com/css?family=Lato:400,100,400italic,700,900italic,900|PT+Serif:400,400italic,700,700italic');

	//style sheet for fontawesome icons 
